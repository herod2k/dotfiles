...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "s", function () awful.util.spawn("urxvt -e ncspot") end),
    ...
    awful.key({ modkey }, "p", function() awful.util.spawn_with_shell("rofi -show run") end,
              {description = "lauch Rofi", group = "launcher"})
)
...
awful.rules.rules = {
    ...
    -- Set Telegram to always map on the tag named "1" on screen 1.
